...
class Body extends React.Component {
  ...
  renderProjects() {
    let projects = [
      ...
      { image: "ct.jpeg", href: 'https://github.com/vla15/MagnanimousMonkeys77', title: "Check Thumbs", description: `A survey application allowing users to poll clients in real-time with the use of web sockets` },
